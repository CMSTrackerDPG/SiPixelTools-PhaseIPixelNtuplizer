...
process = cms.Process('RERECO',Run3_2025)
...
opt.register('globalTag',          '',
	     ...
	     'Global Tag, Default="" which uses auto:run3_data')
...
if opt.dataTier == 'ALCARECO':
    ...
    process.PhaseINtuplizerPlugin.clusterCollection = cms.InputTag("ALCARECOSiPixelCalSingleMuonTight")
